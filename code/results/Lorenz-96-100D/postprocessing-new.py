...
title_ax1.set_title(r'$\dot{x}_i$', loc="center",  fontsize=8, y=0.4)
...
title_ax2.set_title(r'$\dot{\hat{x}}_i$', loc="center",  fontsize=8, y=0.4)
...
#cbar_1.set_ticks([0, 1e-4, 2e-4, 3e-4])
...
ax3.set_xticks(ticks=[0,5,10,15,20])
