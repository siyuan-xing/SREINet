...
ax6.set_ylim(0,8)
ax6.set_yticks([0,4])
ax6.set_xticks([-5, -2.5, 0, 2.5, 4.5])
#ax6.set_xlabel(r'Time, $t$')
ax6.set_ylabel(r'$|{u}_{1}|$', rotation=0)
ax6.yaxis.set_label_coords(-0.17, 0.3)  # Move the label slightly to the left; adjust x-value as needed
#ax6.set_yticks([-5, 5])
#reference_line = 25 
...
ax8.set_xticks([-5, -2.5, 0, 2.5, 4.5])
ax8.set_yticks([])
