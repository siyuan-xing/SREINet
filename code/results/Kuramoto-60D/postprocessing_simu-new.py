...
title_ax1.set_title(r'$\dot{\theta}_i$', loc="center",  fontsize=8, y=0.4)
title_ax1.axis('off')  # Turn off the axis for the title


#### 3 and 4
ax2 = fig.add_subplot(gs[1, 0])
cax2 = ax2.imshow(heat_map_pred_dx, aspect='auto', cmap='cmo.tempo')
...
title_ax2.set_title(r'$\dot{\hat{\theta}}_i$', loc="center",  fontsize=8, y=0.4)
...
cax3 = ax3.imshow(np.abs(heat_map_dx-heat_map_pred_dx), extent=[0, 500, 0, 60], aspect='auto', cmap='cmo.tempo')
...
plt.tight_layout()
#plt.show()
plt.savefig("Kuramoto_60D_results.png", dpi=600)
