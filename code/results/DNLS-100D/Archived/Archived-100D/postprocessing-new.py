...
cax2 = ax2.imshow(heat_map_pred_dx, aspect='auto', extent=[0, 80, -25, 25], cmap='cmo.delta')
...
cax3 = ax3.imshow(np.abs(heat_map_dx-heat_map_pred_dx), extent=[0, 80, -25, 25], aspect='auto', cmap='cmo.delta')
...
pos = [pos.x0, pos.y0, pos.width, pos.height]  # Shift the colorbar to the left by 0.05
...
ax3.set_xticks(ticks=[0, 20, 40, 60, 80])
