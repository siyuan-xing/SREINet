...
num_traj = 1
data_initial_conditions = DG.DataGenerator.generate_initial_conditions(LORENZ96_DIM, num_traj) #np.random.normal(1, 2, LORENZ96_DIM

#data_initial_conditions = np.random.normal(0.0, 1.0, LORENZ96_DIM)
...
for i in range(min(10, LORENZ96_DIM)):  # Show first 10 equations
