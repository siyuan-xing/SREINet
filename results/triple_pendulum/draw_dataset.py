...
# === Plotting ===
fig, axes = plt.subplots(3, 1, figsize=(2, 3))  # Figure size: width 2, height 3

# Plot theta_3
axes[0].plot(time_steps, theta_3, linewidth=1, color=my_colors[0])
axes[0].set_ylabel(r'$\theta_3$ [rad]', fontsize=8)
axes[0].set_yticks([2, 3.2, 4.4])  # Set specific y-axis ticks
axes[0].tick_params(axis='both', which='major', labelsize=8)  # Add ticks
axes[0].spines['top'].set_visible(False)
axes[0].spines['right'].set_visible(False)

# Plot theta_3_dot
axes[1].plot(time_steps, theta_3_dot, linewidth=1, color=my_colors[1])
axes[1].set_ylabel(r'$\dot{\theta}_3$ [rad/s]', fontsize=8)
axes[1].tick_params(axis='both', which='major', labelsize=8)  # Add ticks
...
axes[2].set_ylabel(r'$\ddot{\theta}_3$ [rad/s$^2$]', fontsize=8)
axes[2].tick_params(axis='both', which='major', labelsize=8)  # Add ticks
